  ...
  return (
    <ScrollView>
            ...
            <TouchableHighlight underlayColor= 'transeclucent' onPress={() =>navigation.navigate('Nachislenia')}>
                <View style={{flexDirection: 'row', justifyContent:'center', alignItems: 'center', backgroundColor: '#F0FFF0', borderRadius: 10, width: '80%', marginLeft: 30, marginBottom: 10, padding: 5}}>
