  ...
  return (
    <View style={{ backgroundColor: '#F5F5F5', width: '100%', height: '100%' }}>
      ...
      <TouchableHighlight underlayColor='transpose'
        style={{ width: '60%', height: '10%', marginLeft: 80, marginTop: 20, backgroundColor: '#c0c0c0', borderRadius: 10, justifyContent: 'center', alignItems: 'center' }}
        onPress={handleBackPress}
      >
        <Text style={{ color: '#484AA0', fontSize: 18, fontWeight: '700'}}>Вернуться к списку достижений</Text>
      </TouchableHighlight>
    </View>
  );
}
